...
- Name: tier1.spec.js >> Tier 1: Feature Coverage (Happy Path) >> T1.4.4: Service worker registers successfully in navigator.serviceWorker
- Location: tests/tier1.spec.js:244:3
