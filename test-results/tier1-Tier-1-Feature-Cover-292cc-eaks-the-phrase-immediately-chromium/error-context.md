...
- Name: tier1.spec.js >> Tier 1: Feature Coverage (Happy Path) >> T1.3.4: Clicking a phrasebook item speaks the phrase immediately
- Location: tests/tier1.spec.js:198:3
