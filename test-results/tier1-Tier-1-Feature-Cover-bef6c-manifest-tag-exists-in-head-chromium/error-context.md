...
- Name: tier1.spec.js >> Tier 1: Feature Coverage (Happy Path) >> T1.4.1: Link rel manifest tag exists in head
- Location: tests/tier1.spec.js:221:3
...
- main:
  ...
  - checkbox
  - text: Walkie-Talkie
  - button "Toggle Saved Phrases Drawer": 📁 Saved Phrases
