...
- Name: tier1.spec.js >> Tier 1: Feature Coverage (Happy Path) >> T1.3.2: Travel phrasebook renders categories
- Location: tests/tier1.spec.js:182:3
...
Locator: locator('#phrasebook-list .category-header')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#phrasebook-list .category-header')
